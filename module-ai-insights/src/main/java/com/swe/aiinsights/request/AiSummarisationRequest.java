...
public final class AiSummarisationRequest implements AiRequestable<String> {
    ...
    public AiSummarisationRequest(final String chatJson) {
        ...
        final String prompt =
                "You will receive either: (1) just new chat data, or (2) a previous summary followed by new chat "
                        + "data. Your task is to create a concise, cohesive summary that captures the key points and "
                        + "important information. If there is a previous summary, understand the context from it and "
                        + "integrate the new chat information to create an updated overall summary. Do not just append "
                        + "or list things - synthesize the information into a natural paragraph. Focus on: who "
                        + "participated, main topics discussed, important updates, decisions, and action items. Keep "
                        + "it brief but ensure no critical information is lost. Write in clear, flowing paragraph "
                        + "format. "
